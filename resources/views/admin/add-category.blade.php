                        ...
                        <div class="row mt-3">
                            <form method="POST" action="{{url('admin/add-category')}}">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <input type="text" name="c_name" class="form-control" placeholder="Add category name">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <input type="text" name="c_commission" class="form-control" placeholder="Add comission">
