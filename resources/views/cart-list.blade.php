    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div id="empty-cart-message" class="text-center my-5">
                ...
                <a href="{{url('/')}}" class="btn btn-primary rounded-pill px-4 py-2">Continue Shopping</a>
            </div>
        </div>
    ...
    function renderCart() {
        ...
        cart.forEach((item, index)=> {
            ...
            <tr>
                <th>
                    <div class="d-flex">
                        <div><img src="${item.image_url}" style="width:70px;" class="rounded-3">
                        </div>
                        <div class="p-3">
                ...
                <td><h5>${item.quantity.toLocaleString()}</h5></td>
                <td>${itemTotal.toLocaleString()}</h5></td>
                <td>
