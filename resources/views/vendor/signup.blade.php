                            ...
                            <form method="POST" action="{{url('vendor/signup') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <input value="{{old('full_name')}}" type="text" class="form-control" name="full_name" placeholder="John Doe">
                                        @error("full_name")
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="tel" value="{{old('phone')}}" class="form-control" name="phone" placeholder="+91 ">
                                        @error("phone")
                                        <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="address" placeholder="Enter your address" id="floatingTextarea2" style="height: 100px"></textarea>
                                        @error("address")
                                        <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    </div>
