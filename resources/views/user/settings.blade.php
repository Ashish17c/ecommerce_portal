                        ...
                        <div class="card p-4">
                            ...
                            <div class="col-xl-8 col-md-8">
                                    <h4>Account Setting</h4>
                                        ...
                                        <input type="text" name="fullname" class="form-control" value="{{ $billing->fullname }}" placeholder="John">
                                        </div>

                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" name="email" class="form-control" value="{{ $billing->email }}" placeholder="john@gmail.com">
                                        </div>

                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label">Phone Number</label>
                                            <input type="tel" name="phone" class="form-control" disabled value="{{ $user->phone }}" placeholder="+91 ">
                                        </div>
                                        </div>
                                    ...
                                    <h4>Billing Address</h4>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <input type="text" name="pincode" class="form-control" value="{{ $billing->pincode }}" placeholder="141001">
                                            </div>

                                            <div class="col-lg-6 mb-3">
                                                <label class="form-label">Landmark</label>
                                                <input type="text" name="landmark" class="form-control" value="{{ $billing->landmark }}" placeholder="India Gate">
                                            </div>
