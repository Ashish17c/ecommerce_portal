...
class AdminCategoryController extends Controller
{
    ...
    public function editcategory($c_id){
         ...
         $product_category= Category::where('p_c_id', 0)->get();
        return view('admin/edit-category',compact('category','product_category'));
    }
    ...
    public function deletecategory($c_id){
        ...
        return redirect('admin/view-category')->with('msg','Category delete successfully');
    }
