...
//  checkout route for placing order
...
Route::get('vendor/',[VendorController::class,'index'])->middleware(VendorMiddleware::class);  //Using middleware
...
Route::post('vendor/edit-product/{p_id}', [ProductController::class, 'updateproduct']);
...
Route::post('admin/edit-category/{c_id}', [AdminCategoryController::class, 'updatecategory']);
